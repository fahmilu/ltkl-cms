 ...
 *     @OA\Property(property="social_forestry_ha", type="number", nullable=true, description="Perhutanan Sosial, in hectares", example=21000),
 *     @OA\Property(property="tora_ha", type="number", nullable=true, description="Tanah Objek Reforma Agraria, in hectares", example=9400),
